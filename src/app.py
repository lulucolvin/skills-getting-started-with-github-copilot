...
activities = {
    ...
    "Theater Club": {
        "description": "Drama performances and stage acting workshops",
        "schedule": "Mondays and Thursdays, 5:00 PM - 6:30 PM",
        "max_participants": 25,
        "participants": ["aiden@mergington.edu", "ava@mergington.edu", "chloe@mergington.edu"]
    },
    "Debate Team": {
    ...
    "Science Club": {
        "description": "Explore science experiments, STEM projects, and scientific discovery",
        "schedule": "Wednesdays, 3:30 PM - 4:45 PM",
        "max_participants": 22,
        "participants": ["ethan@mergington.edu", "grace@mergington.edu", "mason@mergington.edu"]
    }
}
